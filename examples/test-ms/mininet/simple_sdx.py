...
class SDXTopo( Topo ):
	...
	main_switch = self.addSwitch( 's1' )
        ...
        self.addParticipant(fabric=main_switch, name = 'a1', port = 5, mac = '08:00:27:89:3b:9f', 
           ip = '172.0.0.01/16', networks = ['100.0.0.0/24', '110.0.0.0/24'], AS = 100)

        self.addParticipant(fabric=main_switch, name = 'b1', port = 6, mac = '08:00:27:92:18:1f', 
           ip = '172.0.0.11/16', networks = ['140.0.0.0/24', '150.0.0.0/24'], AS = 200)
        
        self.addParticipant(fabric=main_switch, name = 'c1', port = 7, mac='08:00:27:54:56:ea',
           ip = '172.0.0.21/16', networks = ['140.0.0.0/24', '150.0.0.0/24'], AS = 300)
        
        self.addParticipant(fabric=main_switch, name = 'c2', port = 8, mac = '08:00:27:bd:f8:b2',
           ip = '172.0.0.22/16', networks = ['140.0.0.0/24', '150.0.0.0/24'], AS = 300)
           
    def addParticipant(self,fabric,name,port,mac,ip,networks,AS):
