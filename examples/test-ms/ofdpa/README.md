...
below._** The switches we chose are Quanta LY2.  To support iSDX's requirement of OpenFlow
1.3, we installed
...
Quanta switches._**  We performed this verification by studying the [OF-DPA documentation]
...
`10.0.0.100:6633`.  The `--dpid=1` uniquely identifies this switch to the controller.  When
