...
if __name__ == "__main__":
    ...
    # hack to add links from a switch to itself
    main_switch = net.getNodeByName('s1')
    # outbound loop
    net.addLink(main_switch, main_switch, 7, 8)
    # inbound loop
    net.addLink(main_switch, main_switch, 9, 10)
    # main-out loop
    net.addLink(main_switch, main_switch, 11, 12)
